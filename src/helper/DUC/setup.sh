...
cd $1
mkdir -p $1/clean_2004/
mkdir -p $1/clean_2004/references
mkdir -p $1/clean_2004/system
python $2/DUC/make_DUC.py --result_docs duc2004_results/ROUGE/eval/models/1/ \
    ...
    --sys_dir clean_2004/system --root_dir clean_2004/

mkdir -p $1/clean_2003/
mkdir -p $1/clean_2003/references
mkdir -p $1/clean_2003/system
python $2/DUC/make_DUC.py --result_docs detagged.duc2003.abstracts/models/ \
    ...
    --sys_dir clean_2003/system --root_dir clean_2003/
